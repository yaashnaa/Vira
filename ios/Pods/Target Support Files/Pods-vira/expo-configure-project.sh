...
with_node \
  ...
  --target "/Users/yashna/Desktop/Vira-Folder/Vira-mobile-app/ios/Pods/Target Support Files/Pods-vira/ExpoModulesProvider.swift" \
  --entitlement "/Users/yashna/Desktop/Vira-Folder/Vira-mobile-app/ios/vira/vira.entitlements" \
  --platform "apple" \
  --packages "expo" "expo-application" "expo-asset" "expo-blur" "expo-constants" "expo-device" "expo-file-system" "expo-font" "expo-haptics" "expo-image" "expo-keep-awake" "expo-linking" "expo-notifications" "expo-router" "expo-splash-screen" "expo-symbols" "expo-system-ui" "expo-video" "expo-web-browser"
