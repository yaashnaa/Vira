...
const storeData = async ({ value, key = "@amount" }: StoreDataParams): Promise<void> => {
    try {
...
const getData = async ({ key, setValue }: GetDataParams): Promise<void> => {
    try {
...
//       },
//       trigger: {
//         type: Notifications.AndroidNotificationPriority.TIME_INTERVAL,
//         repeats: true,
//         seconds: 60,
//       },
//     });
