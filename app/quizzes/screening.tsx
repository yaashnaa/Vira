          ...
          <SafeAreaView style={styles.section}>
            ...
            <View>
              <Text style={styles.question}>
                ...
                example, hiding calorie counts, providing gentle prompts instead
                of strict daily targets)?
              </Text>
              <View style={styles.optionContainer}>
                {[
      ...
      case 2:
        return (
          <SafeAreaView style={styles.container}>
            <Text style={styles.sectionTitle}>
              3.0 Personal Goals & App Preferences
            </Text>
            <View>
              <Text style={styles.question}>
            ...
            <View>
              <Text style={styles.question}>
                Would you prefer a manual or adaptive approach to setting goals?
              </Text>
              <View style={styles.optionContainer}>
                {[
